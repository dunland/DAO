 ...
 * time() will be printed with 't' hit
 ...
 28.10.2018
 Version 02_05:
 * initial Mode selection introduced!
 -> grid distribution
 -> random distribution
 -> free allocation
 * time stamps in console prints added
 * 2 color modes: 
 -> subsideAfterEmission = 0
 -> waitBeforeReaction = RGB
 
 TO DO: 
 * one sound object for each module --> real multilayer sound
